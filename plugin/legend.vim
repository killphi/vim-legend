...
function! s:Deprecated(deprecated, correct, cmd)
  call s:message(a:deprecated . " is deprecated, please use " . a:correct . " in the future")
  exec a:cmd
endfunction

command! -nargs=0  Cov              call s:Deprecated(":Cov",   ":LegendEnable",  "call s:EnableLegend()")
command! -nargs=0  LegendEnable     call s:EnableLegend()
command! -nargs=0  Uncov            call s:Deprecated(":Uncov", ":LegendDisable", "call s:DisableLegend()")
